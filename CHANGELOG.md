...
- Added `enqueue_block_editor_critical_style()` and `enqueue_block_editor_critical_script()` methods to `Enqueue` class for loading critical assets as file enqueues inside the block editor iframe
